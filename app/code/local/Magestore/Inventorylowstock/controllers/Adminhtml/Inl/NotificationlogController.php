 ...
 */
class Magestore_Inventorylowstock_Adminhtml_Inl_NotificationlogController extends Magestore_Inventoryplus_Controller_Action {
     ...
     * @var string 
     */
    protected $_menu_path = 'inventoryplus/stock_control/stock_history/lowstock';
    ...
    public function gridAction() {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('inventorylowstock/adminhtml_notificationlog_grid')->toHtml()
        );
    }
