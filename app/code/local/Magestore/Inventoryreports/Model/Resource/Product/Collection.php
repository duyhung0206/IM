...
class Magestore_Inventoryreports_Model_Resource_Product_Collection extends Mage_Reports_Model_Resource_Product_Collection
{

    public function addOrderedQty($from = '', $to = '')
    {
        $adapter = $this->getConnection();
        $compositeTypeIds = Mage::getSingleton('catalog/product_type')
                ->getCompositeTypes();
        ...
        $this->getSelect()->reset()
                ...
                ->having('order_items.product_id <>  ?', 'NULL')
                ->having('e.sku <>  ?', 'NULL')
                ;
