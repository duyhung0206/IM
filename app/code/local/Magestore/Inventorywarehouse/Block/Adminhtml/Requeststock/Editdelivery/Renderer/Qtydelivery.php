...
class Magestore_Inventorywarehouse_Block_Adminhtml_Requeststock_Editdelivery_Renderer_Qtydelivery extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row)
    {
        ...
        $str = Mage::helper('inventorywarehouse')->__('Received: '). $row->getTotalDelivery() .'/'. $row->getTotalRequest();
